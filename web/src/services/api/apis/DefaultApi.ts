...
export class DefaultApi extends runtime.BaseAPI {
    ...
    /**
     */
    async downloadGetRaw(requestParameters: DownloadGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
    ...
    /**
     */
    async downloadGet(requestParameters: DownloadGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.downloadGetRaw(requestParameters, initOverrides);
    }
